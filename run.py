...
def get_sales_data(): 
    ...
    the terminal, which must be a string of 6 numbers separated
...
def get_last_5_entries_sales():
    """
    Collects culumns of data from sales worksheet, collecting the last
...
def calculate_stock_data(data):
    ...
    for column in data:
        ...
        average = sum(int_column) / len(int_column)  # 5 would do also
